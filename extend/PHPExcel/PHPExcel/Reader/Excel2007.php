                                    ...
                                    if ($zip->locateName(dirname("$dir/$fileWorksheet") . "/_rels/" . basename($fileWorksheet) . ".rels")) {
                                        ...
                                        if ($vmlRelationship != '') {
                                            ...
                                            foreach ($relsVML->Relationship as $ele) {
                                                if ($ele["Type"] == "http://schemas.openxmlformats.org/officeDocument/2006/relationships/img") {
...
//        }
    ...
    private function readRibbon($excel, $customUITarget, $zip)
    {
        ...
        if ($dataRels) {
            ...
            if ($UIRels) {
                // we need to save id and target to avoid parsing customUI.xml and "guess" if it's a pseudo callback who load the img
