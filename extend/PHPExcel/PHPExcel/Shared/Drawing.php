...
class PHPExcel_Shared_Drawing
{
    ...
    /**
     * Create a new img from file. By alexander at alexauto dot nl
     *
     * @link http://www.php.net/manual/en/function.imagecreatefromwbmp.php#86214
     * @param string $filename Path to Windows DIB (BMP) img
     * @return resource
     */
    public static function imagecreatefrombmp($p_sFile)
    {
        //    Load the img into a string
        ...
        for ($i = 0; $i < $body_size; $i += 3) {
            ...
            if ($x >= $width) {
                // If padding needed, ignore img-padding
                ...
                //    Reached the img-height? Break the for-loop
                if ($y > $height) {
                    break;
                }
            }

            // Calculation of the RGB-pixel (defined as BGR in img-data)
