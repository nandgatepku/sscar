    ...
    private function writeImageInCell(PHPExcel_Worksheet $pSheet, $coordinates)
    {
        ...
        foreach ($pSheet->getDrawingCollection() as $drawing) {
            if ($drawing instanceof PHPExcel_Worksheet_Drawing) {
                ...
                imagepng($drawing->getImageResource());    //  This will normally output the img, but because of ob_start(), it won't.
                $contents = ob_get_contents();             //  Instead, output above is saved to $contents
                ob_end_clean();                            //  End the output buffer.

                $dataUri = "data:img/jpeg;base64," . base64_encode($contents);

                //  Because of the nature of tables, width is more important than height.
                //  max-width: 100% ensures that img doesnt overflow containing cell
                //  width: X sets width of supplied img.
